<?php
	...
	function saveOrder($tireQty, $oilQty, $sparkQty, $totalAmount) {
		...
		$file = @ fopen(DOCUMENT_ROOT.'/dragon-php/dragon-php/bobs-auto-parts/resource/orders.txt', 'ab');
	...
	function getOrders() {
		...
		$file = @ fopen(DOCUMENT_ROOT.'/dragon-php/dragon-php/bobs-auto-parts/resource/orders.txt', 'rn');
