<?php
  ...
  require_once 'service/process-order-calculate-vat-service.php';
?>
...
<?php
  ...
  echo '</p> Vatable Amount: ' .getVatableAmount($product->getProductTotalAmount());
  echo '</p> VAT Amount: ' .getVat($product->getProductTotalAmount());
  ...
  <?php saveOrder($tires->getTireItemQuantity(), $oils->getOilItemQuantity(),$sparkPlugs->getSparkPlugItemQuantity(),$product->getProductTotalAmount()); ?>
