            ...
            <div class="card-body">
                <?php
                  ...
                  try {
                    ...
                    //This will create a hashed password that will be stored in the db
                    //This will make the password of the user unknown even to the admins and developers
                    //'sha512' is a php algorithm from https://www.php.net/manual/en/function.hash-algos.php
